 ...
 */
$config['site_title'] = "Sistema de apoyo para la evaluación de saberes en cursos de programación.";       // Site Title, example.com
$config['admin_email'] = "sis.saescp.admi@gmail.com"; // Admin Email, admin@example.com
...
$config['max_password_length'] = 9;                  // Maximum Allowed Length of Password
