...
class Ion_auth_model extends CI_Model {
     ...
     * @author Mathew
     * */
    public function register($identity, $password, $email, $nombre, $groups = array()) {
        ...
        //$user_data = array_merge($this->_filter_data($this->tables['users'], $nombre), $data);
    ...
    public function login($identity, $password, $remember = FALSE) {
        ...
        $query = $this->db->select($this->identity_column . ', email, id, password, active, last_login,nombre')
                ->where($this->identity_column, $identity)
                ->limit(1)
                ->order_by('id', 'desc')
                ->get($this->tables['users']);
